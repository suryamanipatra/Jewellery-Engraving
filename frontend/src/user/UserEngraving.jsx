                            ...
                            <div className="w-full md:w-full lg:w-full lg:w-2/5 flex flex-col items-center relative">
                                ...
                                <div className="relative flex items-center justify-center lg:justify-start">
                                    ...
                                    <div className="grid md:grid-cols-4 2xl:grid-cols-2 gap-2 mx-2 ml-10 mr-10">
                                        <div className="bg-white p-2 w-24 md:w-28 lg:w-32 rounded-lg shadow-lg aspect-square flex items-center justify-center">
                                            <img src={kamaLogo} alt="View 1" className="w-full h-full object-contain rounded-md" />
                                        </div>
                                        <div className="bg-white p-2 w-24 md:w-28 lg:w-32 rounded-lg shadow-lg aspect-square flex items-center justify-center">
                                            <img src={kamaLogo} alt="View 2" className="w-full h-full object-contain rounded-md" />
                                        </div>
                                        <div className="bg-white p-2 w-24 md:w-28 lg:w-32 rounded-lg shadow-lg aspect-square flex items-center justify-center">
                                            <img src={kamaLogo} alt="View 3" className="w-full h-full object-contain rounded-md" />
                                        </div>
                                        <div className="bg-white p-2 w-24 md:w-28 lg:w-32 rounded-lg shadow-lg aspect-square flex items-center justify-center">
                                            <img src={kamaLogo} alt="View 4" className="w-full h-full object-contain rounded-md" />
                                        </div>
                                    </div>
                                    <IoIosArrowForward className='text-white' size={32} />
                                </div>
                            </div>
                            <div className="w-full  md:h-[40vh] lg:h-[60vh] 2xl:h-full flex items-center justify-center bg-white rounded-2xl shadow-md">
                                <img src={kamaLogo} className="w-full h-full object-contain" />
                            </div>
                        </div>
