...
const handleSubmit = async (e) => {
  ...
  const handleChangeForForgotPassword = (e) => setFormDataForForgotPassword({ ...formData, [e.target.name]: e.target.value });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      await axios.post(`${API_BASE_URL}/reset-password`, {
        ...
        newPassword: formDataForForgotPassword.password,
      });
